...
//------------------- BEGIN YOUR CODE
	...
	/*addSphere({
		x : planets.mercury.distance,
		vz : planets.mercury.velocity,
		name : "mercury"
...
//------------------- BEGIN YOUR CODE
	...
	r = Math.sqrt(obj.pos.x * obj.pos.x + obj.pos.y * obj.pos.y + obj.pos.z * obj.pos.z);

	newAx = -(gravityConst * obj.pos.x)/(r*r); 
	newAy = -(gravityConst * obj.pos.y)/(r*r);
	newAz = -(gravityConst * obj.pos.z)/(r*r);
